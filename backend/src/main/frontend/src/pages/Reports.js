...
export default class Reports extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      projects: [
        {id: 1, title: 'first project', body: 'first description'},
        {id: 2, title: 'second project', body: 'second description'},
      ],
  ...
  render() {
    ...
    <div className="px-4 mb-4 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
      ...
      <a key ={projects.id}  href="single-note.html" className="bg-blue-200 p-3 rounded shadow">
        <div className="flex justify-between items-center mb-1">
          <h1 className="font-medium text-lg">{projects.title}</h1>
        </div>
